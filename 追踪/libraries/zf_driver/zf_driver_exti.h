...
typedef enum{                                                                   // 枚举 EXTI 触发信号  此枚举定义不允许用户修改
    EXTI_TRIGGER_RISING  = EXTI_TriggerIn_RisingEdge,                           // 上升沿触发模式
    EXTI_TRIGGER_FALLING = EXTI_TriggerIn_FallingEdge,                          // 下降沿触发模式
    EXTI_TRIGGER_BOTH    = EXTI_TriggerIn_BothEdges,                            // 双边沿触发模式
}exti_trigger_enum;
